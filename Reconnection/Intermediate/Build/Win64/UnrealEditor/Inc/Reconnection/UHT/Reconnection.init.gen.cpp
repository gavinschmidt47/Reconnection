...
void EmptyLinkFunctionForGeneratedCodeReconnection_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_Reconnection()
	{
		if (!Z_Registration_Info_UPackage__Script_Reconnection.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_Reconnection_OnTurnChanged__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_Reconnection(Z_Construct_UPackage__Script_Reconnection, TEXT("/Script/Reconnection"), Z_Registration_Info_UPackage__Script_Reconnection, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x10FACA10, 0x5120068A));
